...
class Homepage_Card {
    ...
    * */
    ...
    _createCard_backApplicationBox () {
        ...
        let back_apptitle_html = `<div class="apptitle BackBigTitle">应用领域</div>`; 
   ...
   //卡片的浅色部分
    _createCard_frontBody () {
        ...
        Homepage_Card.card_body_front_titleArray.forEach((title, i, titleList) => {
            ...
            // }
            if(i==1){
                card_frontBody_textHtml = `<p class="card-body-text"><b>发表渠道: </b>${card_body_front_textArray[i]}</p>`;
                card_body_node.innerHTML+= (card_frontBody_titleHtml + card_frontBody_textHtml); 
                return;
            }
            if(i==2){
                card_frontBody_textHtml = `<p class="card-body-text"><b>链接: </b><a classname="caselink" href=${card_body_front_textArray[i]}  target="_blank">URL 🔗</a></p>`;
                card_body_node.innerHTML+= (card_frontBody_titleHtml + card_frontBody_textHtml); 
                return;
            }
    ...
    _createCard_backBody () {
        ...
        let back_typetitle_html = `<div class="apptitle BackBigTitle">贡献类型</div>`; 
        let app_fields_node = document.createElement("div");
    ...
    _createCard_backCode () {
        ...
        let back_codetitle_html = `<div class="apptitle BackBigTitle">底层维度</div>`; 

        let app_fields_node = document.createElement("div");
        let app_fields_text_html = `
        <div class="codes-left">
            <div class="codes-title">互动范围</div> 
            <div class="back-text-content">${this.parameters["互动范围"]}</div><br/>
            <div class="codes-title">使用门槛</div>
            <div class="back-text-content">${this.parameters["使用门槛"]}</div><br/>
            <div class="codes-title">主导权</div>
            <div class="back-text-content">${this.parameters["主导权"]}</div><br/>
            <div class="codes-title">敏捷度</div>
            <div class="back-text-content">${this.parameters["敏捷度"]}</div><br/>
            <div class="codes-title">显现度</div>
            <div class="back-text-content">${this.parameters["显现度"]}</div>
        </div>
